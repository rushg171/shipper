export default function Totals(){
    ...
    <div className="grid grid-cols-5 p-6 gap-6 w-full justify-center items-center">
        ...
        <div className="grid grid-cols-3 col-span-3 rounded-xl bg-blue-100 text-black text-sm border-1 border-blue-700 h-26 text-start p-3 justify-center items-center">
            ...
            <div className="flex-col justify-center text-center items-center ">
                <div><span className="font-bold">Total Cost</span></div>
               <div><span className="font-bold text-blue-800 text-3xl">$510</span></div>
            </div>
        </div>
        </div>
        <div className="flex justify-end w-full pb-6 px-6 gap-4">
            ...
            <button className="bg-blue-700 rounded-full min-w-40 hover:bg-orange-500 text-white font-semibold">Save for later</button>
            <button className="bg-blue-200 border-1 border-blue-700 p-4 rounded-full  text-blue-700 font-semibold">Create Shipment</button>
