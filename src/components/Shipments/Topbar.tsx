...
export default function Topbar(){
    ...
    let currentStage = 4;
    return (
        <div className="bg-lightbackground-200 flex flex-row justify-center items-center h-20 px-6 w-full">
                    ...
                    stages.map((stageName, ind)=>{
                        ...
                        return (
                            <div className="flex gap-3 items-center">
                                ...
                                <span>{stageName}</span>
                                {ind != stages.length-1 && <div className="w-8 h-0.5 bg-primary-500 rounded-2xl"/>}
                            </div>
                        )
                    })
                }
